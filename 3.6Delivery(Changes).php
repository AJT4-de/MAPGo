...
<body id="page-top">
        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">MAPGo</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" aria-controls="navbarResponsive"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="#portfolio">Services</a>
       ...
       <section id="portfolio" class="portfolio bg-primary">
        <div class="container-fluid mt-5">
            <h2 class="text-uppercase text-center text-light">changes</h2>
            <hr class="star-light mb-5">
            <div class="row"> </div> <div class="row">
				<div>
              <div> <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>the consumer </strong> <span>*</span></label>
              <input type="text" name="contactno" class="form-control white_bg" id="phonenumber" required>
            </div><br>
					<div> <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>has requested a time change to </strong> <span>*</span></label>
              <input type="text" name="contactno" class="form-control white_bg" id="phonenumbr" required>
            </div><br><div> <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>Cancellation Request </strong> <span>*</span></label>
              <input type="text" name="contactno" class="form-control white_bg" id="phonenumbr" required>
            </div>
			  </div>
            </div>
