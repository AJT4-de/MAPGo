          ...
          <button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" aria-controls="navbarResponsive"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="#page-top">home</a></li>
                    <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="#about">About</a></li>
                    ...
                    <a class="btn btn-light btn-lg mx-auto  portfolio-modal-dismiss text-uppercase " href="Login3.php" role="button" ><strong>admin</strong></a>
                </ul>
            </div>
      </div>
    </nav>
<header class="masthead bg-primary text-white text-center pt-6">
        <div class="container">
			<h1 class="font-weight-light mb-3 " style="font-size:60px;"><strong>Welcome To Our Project !</strong></h1> 
			<img class="img-fluid d-block mx-auto mb-3" src="assets/img/fast-delivery.png"
				 width="200" > 
			<a class="btn btn-secondary btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase " href="Login.php" role="button" onClick="conlog()"><strong>CUSTOMER</strong></a>
			
			
			
			<a class="btn btn-secondary btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase" href="login2.php" role="button"><strong>delivery partner</strong></a>
			<hr class="star-light">
          <h1>IT'S NICE TO SERVE YOU</h1>
			
      </div>
    </header>
<section id="about" class="bg-white text-dark mb-0">
    <div class="container">
            <h2 class="text-uppercase text-center text-dark">About</h2>
      <hr class="star-dark mb-5">
            <div class="row">
                <div class="col-lg-4 ml-auto">
                    <p class="lead">_text filler**</p>
                </div>
                <div class="col-lg-4 mr-auto">
                    <p class="lead">text filler<br><br><br></p>
                </div>
            </div>
            <div class="text-center mt-4"><a class="btn btn-outline-dark btn-xl" role="button" href="#"><span>Liked our Work&nbsp; !</span></a></div>
  </div>
    </section>
...
<footer class="footer text-center">
	...
	<script>
		function conlog()
		{
		var logform = document.getElementById('logcon');
