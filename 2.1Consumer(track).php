...
<body id="page-top">
    ...
    <section id="portfolio" class="portfolio bg-primary">
		...
		<div class="row">
		 ...
		 <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>TOTAL  AMOUNT</strong> <span>*</span></label>
...
<section id="contact" style="background-image:url('assets/img/map-image.png');background-color: #2C3E50;">
    ...
    <a class="d-block js-scroll-trigger text-center text-white rounded" href="#page-top"><i class="fa fa-chevron-up"></i></a></div>
...
<script type="module">
    ...
    from "https://cdnjs.cloudflare.com/ajax/libs/firebase/9.6.7/firebase-database.min.js";
