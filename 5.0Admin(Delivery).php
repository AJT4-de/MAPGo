...
<body id="page-top">
    <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-secondary text-camelcase" id="mainNav">
          ...
          <button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" aria-controls="navbarResponsive"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
					<li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="5.0Admin(Delivery).php">Home</a></li>
					<li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="6.0Admin(Order).php">order</a></li>
					 <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="4.0Admin(Consumer).php">Consumer</a></li>
            <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="#page-top">Delivery agent</a></li>
        ...
        <div class="container-fluid mt-5">
            <h2 class="text-uppercase text-center text-light" style="font-size:75px">Delivery agent</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-6  mt-5 col-lg-4">
                    <a class="d-block mx-auto portfolio-item" data-toggle="modal" href="#portfolio-modal-2">
                        <div class="d-flex portfolio-item-caption position-absolute h-100 w-100">
                            <div class="my-auto portfolio-item-caption-content w-100 text-center text-white"><p><b>ADD AGENT</b></p></div>
                        </div><img class="img-fluid" src="assets/img/New folder/add.png"></a>
                </div>
                <div class="col-md-6 mt-5 col-lg-4">
                    <a class="d-block mx-auto portfolio-item" data-toggle="modal" href="#portfolio-modal-3">
                        <div class="d-flex portfolio-item-caption position-absolute h-100 w-100">
                            <div class="my-auto portfolio-item-caption-content w-100 text-center text-white"><p><b>REPORTED AGENTS</b></p></div>
            ...
            <div class="container text-center">
              <div class="row">
                <div class="col-lg-8 mx-auto">
                  <h2 class="text-uppercase text-secondary mb-0">DETAILS OF DELIVERY AGENTS</h2>
                  <hr class="star-dark mb-5">
                  <img class="img-fluid mb-5" src="assets/img/New folder/employee.png">
                  <p class="mb-5">(----TEXT----)</p>
                </div>
              </div>
            </div>
          </div>
          <div class="modal-footer pb-5"><a class="btn btn-primary btn-lg mx-auto rounded-pill portfolio-modal-dismiss" role="button" href="5.1Admin(Delivery)details.php">Proceed</a>
				</div>
        </div>
      </div>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="container text-center">
              <div class="row">
                <div class="col-lg-8 mx-auto">
                  <h2 class="text-uppercase text-secondary mb-0">ADD A NEW AGENT</h2>
                  <hr class="star-dark mb-5">
                  <img class="img-fluid mb-5" src="assets/img/New folder/add.png">
                  <p class="mb-5">(----TEXT----)</p>
                </div>
              </div>
            </div>
          </div>
           <div class="modal-footer pb-5"><a class="btn btn-primary btn-lg mx-auto rounded-pill portfolio-modal-dismiss" role="button" href="5.4Admin(Delivery)create.php">Proceed</a>
				</div>
        </div>
      </div>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="container text-center">
              <div class="row">
                <div class="col-lg-8 mx-auto">
                  <h2 class="text-uppercase text-secondary mb-0">REPORTED AGENTS</h2>
                  <hr class="star-dark mb-5">
                  <img class="img-fluid mb-5" src="assets/img/New folder/complain.png">
                  <p class="mb-5">(----TEXT----)</p>
                </div>
              </div>
            </div>
          </div>
           <div class="modal-footer pb-5"><a class="btn btn-primary btn-lg mx-auto rounded-pill portfolio-modal-dismiss" role="button" href="5.3Admin(Delivery)reports.php">Proceed</a>
				</div>
        </div>
      </div>
    </div>
