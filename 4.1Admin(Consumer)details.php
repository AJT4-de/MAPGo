...
<head>
    ...
    <title>Admin(Consumer)Details</title>
   ...
   <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-secondary text-camelcase" id="mainNav" >
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="#page-top">consumer</a></li>
					 <li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="5Admin(Delivery).php">Delivery agent</a></li>
       ...
       <section id="portfolio" class="portfolio bg-primary">
        <div class="container-fluid mt-5">
            <h2 class="text-uppercase text-center text-light">consumer details&nbsp;</h2>
            <hr class="star-light mb-5">
          <div><div style="align-content:center; width:50% ">
              <form>
				  <div class="form-group">
					    <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>consumer id</strong> <span>*</span></label>
					  <input type="text" name="firstname" class="form-control white_bg" id="firstname" required><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>search </strong><span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a><br>
              ...
              <input type="text" name="firstname" class="form-control white_bg" id="firstname" required>
            </div>
            <div class="form-group">
              <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>last Name</strong> <span>*</span></label>
              <input type="text" name="lastname" class="form-control white_bg" id="lastname" required>
            </div>
				  <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="contactno" class="form-control white_bg" id="address" required>
                    </form>
            </div></div>
        </div>
    </section>
