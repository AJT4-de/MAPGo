...
<body id="page-top">
       ...
       <section id="portfolio" class="portfolio bg-primary">
        <div class="container-fluid mt-5">
            <h2 class="text-uppercase text-center text-light">report consumer</h2>
            <hr class="star-light mb-5">
            <div class="row"> </div><div style="align-content: center">
              <div style="text-align:center; width: 50%; margin-left:auto;margin-right:auto">
				  <table style="width:100% ;text-align:center">

  <tr>
    <td><div ><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>rude</strong></a></div><br></td>
    <td><div ><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>misbheaved</strong></a></div><br></td>
  </tr>
  <tr>
    <td><div ><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>did not pay </strong></a></div><br></td>
    <td><div><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>other </strong></a></div><br></td>
				  ...
				  <a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>submit</strong><span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
		</div>
