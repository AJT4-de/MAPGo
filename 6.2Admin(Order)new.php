...
<head>
    ...
    <title>Admin(Consumer)New</title>
   ...
   <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-secondary text-camelcase" id="mainNav" >
       ...
       <section id="portfolio" class="portfolio bg-primary">
        <div class="container-fluid mt-5">
            <h2 class="text-uppercase text-center text-light">New order</h2>
            <hr class="star-light mb-5">
            <div style="float: "><div style="width:50% ">
              <form>
				  <div class="form-group">
					    <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>package id</strong> <span>*</span></label>
					  <input type="text" name="firstname" class="form-control white_bg" id="pid" required><br>
              <label class="control-label text-uppercase text-light text-center" style="font-family:Montserrat"><strong>consumer id</strong> <span>*</span></label>
              <input type="text" name="fi" class="form-control white_bg" id="cid" required>
            </div>
            <div class="form-group">
              <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>delivery agent id</strong> <span>*</span></label>
              <input type="text" name="lastname" class="form-control white_bg" id="did" required>
            </div>
				  <div class="form-group">
              <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>price</strong> <span>*</span></label>
