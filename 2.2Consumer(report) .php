...
<body id="page-top">
        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">MAPGo</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" aria-controls="navbarResponsive"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
					<li class="nav-item mx-0 mx-lg-1" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-uppercase" href="2.0Consumer.php">Home</a></li>
    ...
    <section id="portfolio" class="portfolio bg-primary">
        <div class="container-fluid mt-5">
            <h2 class="text-uppercase text-center text-light">package issues</h2>
  ...
  <tr>
    <td><div ><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>damaged item</strong></a></div><br></td>
    <td><div ><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>wrong item </strong></a></div><br></td>
  </tr>
  <tr>
    <td><div ><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>item missing </strong></a></div><br></td>
    <td><div><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>other </strong></a></div><br></td>
  </tr>
</table><br><div class="form-group">
                    <textarea name="message" required="" class="form-control" id="complaint" placeholder="Your Message *"></textarea>
                    <small class="form-text text-danger help-block lead"></small></div><a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>submit </strong></a>
		</div>
              ...
              <div class="form-row">
                <div class="col col-md-6">
                  <div class="form-group">
                    ...
                    <small class="form-text text-danger flex-grow-1 help-block lead"></small></div>
                  <div class="form-group">
