...
if($_SERVER['REQUEST_METHOD'] == "POST"){$fn=$_POST['tfn'];
	 $sn=$_POST['tsn'];
	 $pn=$_POST['tpn'];
	 $tad=$_POST['ta'];
	 $te=$_POST['te'];
     ...
     $query=INSERT INTO `deliveragentdetails`(`firstname`, `lastname`, `phonenumber`, `email`, `deliveryangentid`, `username`, `password`) 
     VALUES ('$fn','$sn','$pn','$te','$userid','$us','$pss');
...
<head>
    ...
    <title>Admin(Delivery)create</title>
...
<h2 class="text-uppercase text-center text-light">new agent</h2>
            <hr class="star-light mb-5">
			
</div><div><div style="align-content:center; width:50% ">
              <form>
				  <div class="form-group">
					    <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>User name</strong> <span>*</span></label>
					  <input type="text" name="usser" class="form-control white_bg" id="tusn" required><br>
                      <label class="control-label text-uppercase text-light" style="font-family:Montserrat"><strong>Password</strong> <span>*</span></label>
					  <input type="text" name="pass" class="form-control white_bg" id="tpss" required><br>
            ...
            <div class="form-group">
				<a class="btn btn-light btn-lg mx-auto rounded-pill portfolio-modal-dismiss text-uppercase "  style="font-family:Montserrat" role="button"><strong>create </strong><span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
